...
namespace UzWorks.BL.Services.TelegramMessageSenderBot
{
    ...
    {
        public static async Task SendMessageForWorkerAsync(Root updatedResponse, 
                                                           WorkerVM shablon, 
                                                           Guid id)
        {
            ...
            foreach (var update in updatedResponse.result)
            {
                ...
                var message = TelegramMessageSenderService.GenerateTelegramMessageForWorker(shablon);
                    ...
                    reply_markup = new
                    {
                        inline_keyboard = new[]
                        {
                                new[]
                                {
                                    ...
                                    {
                                        text = "WebSite",
                                        url = $"https://uzworks.uz/workers/{id}"
                                    }
                                }
                            }
                    }
        ...
        public static string GenerateTelegramMessageForWorker(WorkerVM model)
        {
